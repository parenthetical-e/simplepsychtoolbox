...
%   paint_image                - Paints an image on the Screen (e.g. moocow.jpeg).
%   paint_nothing              - Paints nothing (an empty black screen).
...
%   ttl_release_INC            - Releases (i.e. unpauses) the script on receipt of a TTL pulse. Waits forever.
...
%   write_countdown            - A counter, writing seconds till start.
...
%   create_outfile             - Creates a file (returning its handle) for later writing.
%   load_matrix_from_input_dir - Document this please Kurt. WTF is this!?!  :)
%   preload_sounds             - Prereads all the sound files sound_dir_name into a struct named sounds_data.
%   thank_and_lock             - Leave a 'thank you' onscreen until the secret key ('f') is pressed.
