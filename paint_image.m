function [VBLTimestamp onset_time] = paint_image(img_name,images_data,0,window,coords,colors),

	stim = Screen('MakeTexture', window, images_data.(genvarname(img_name));
